...
const User = () => {
	...
	const [showBakePay, setShowBakePay] = useState(false);
		...
		<Container>
			...
			<Menu>
					...
					<MyMenu>
						...
						<nav>
							<div>
								...
								<span onClick={toggleOrderList}>구매목록</span>
							</div>
							<div>
								<p>My 정보</p>
								<span onClick={toggleUserInfo}>개인정보확인</span>
								<span onClick={toggleBakePay}>결제수단·페이관리</span>
							</div>
						</nav>
					</MyMenu>
				</LeftMenu>
				<RightMenu>
					...
					{showCart && <CartPage />}
					{showOrder && <PurchaseListPage />}
					{showBakePay && <PaymentManagement />}
